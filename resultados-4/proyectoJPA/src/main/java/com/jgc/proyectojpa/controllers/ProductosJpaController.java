...
public class ProductosJpaController implements Serializable {
  ...
  public void edit(Productos productos) throws IllegalOrphanException, NonexistentEntityException, Exception {
    ...
    try {
      ...
      List<Ventas> ventasCollectionOld = persistentProductos.getVentasCollection();
      List<Ventas> ventasCollectionNew = productos.getVentasCollection();
  ...
  public void destroy(Short id) throws IllegalOrphanException, NonexistentEntityException {
    ...
    try {
      ...
      List<String> illegalOrphanMessages = null;
      List<Ventas> ventasCollectionOrphanCheck = productos.getVentasCollection();
